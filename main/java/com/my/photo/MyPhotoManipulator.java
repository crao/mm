...
public class MyPhotoManipulator implements PhotoManipulator{
	...
	public MyPhotoManipulator() {
		this(readClassImage("/static/images/logo.png"));
	}
	
	public MyPhotoManipulator(BufferedImage logo){
	...
	private void renderOverlay(BufferedImage image, Graphics2D graphics) {
		...
		int y = image.getHeight() - this.logo.getHeight();
		graphics.drawImage(this.logo, 0, y, null);
	}
